...
SWIFT_CLASS("_TtC11StarryStars10RatingView")
...
@property (nonatomic, strong) UIImage * __nullable offImage;

/// Image of fully lit star, if nil "starryStars_on" is used
@property (nonatomic, strong) UIImage * __nullable onImage;

/// Image of half-lit star, if nil "starryStars_half" is used
@property (nonatomic, strong) UIImage * __nullable halfImage;
...
@property (nonatomic, weak) id <RatingViewDelegate> __nullable delegate;
...
@interface RatingView (SWIFT_EXTENSION(StarryStars))
...
SWIFT_PROTOCOL("_TtP11StarryStars18RatingViewDelegate_")
@protocol RatingViewDelegate
